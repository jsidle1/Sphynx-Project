...
class Game extends Phaser.Scene
{
    ...
    preload ()
    {
        ...
        // blue arrow assets
        this.load.image('blue_arrow_down', './assets/Blue_Arrow_down.png');
        this.load.image('blue_arrow_up', './assets/Blue_Arrow_Up.png');
        this.load.image('blue_arrow_left', './assets/Blue_Arrow_Left.png');
        this.load.image('blue_arrow_right', './assets/Blue_Arrow_Right.png');

        // red arrow assets
        this.load.image('red_arrow_down', './assets/Red_Arrow_down.png');
        this.load.image('red_arrow_up', './assets/Red_Arrow_Up.png');
        this.load.image('red_arrow_left', './assets/Red_Arrow_Left.png');
        this.load.image('red_arrow_right', './assets/Red_Arrow_Right.png');

        // green arrow assets
        this.load.image('green_arrow_down', './assets/Green_Arrow_down.png');
        this.load.image('green_arrow_up', './assets/Green_Arrow_Up.png');
        this.load.image('green_arrow_left', './assets/Green_Arrow_Left.png');
        this.load.image('green_arrow_right', './assets/Green_Arrow_Right.png');

        // pink arrow assets
        this.load.image('pink_arrow_down', './assets/Pink_Arrow_down.png');
        this.load.image('pink_arrow_up', './assets/Pink_Arrow_Up.png');
        this.load.image('pink_arrow_left', './assets/Pink_Arrow_Left.png');
        this.load.image('pink_arrow_right', './assets/Pink_Arrow_Right.png');
